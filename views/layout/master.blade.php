...
<div class="container theme-showcase" role="main">
                ...
                <div style="padding-top:20px;">
                    <form class="form-horizontal" action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name='renda1' class="form-control" id="renda1"
    ...
    <div role="tabpanel" class='tab-pane active' id="sucesso">
        <div style="padding-top:20px;">
            <div class="alert alert-info" role="alert">Dados do usuário inserido com sucesso! Deseja inserir novo
                usuário? <a href="destroi_sessao.php">CLIQUE AQUI</a></div>
        </div>
    </div>
    <?php }
    ?>
